...
namespace EasyPrimitiveAnimals
{
    public class AnimalController : MonoBehaviour
    {
        ...
        private void Start()
        {
            if (!this.gameObject.CompareTag("animals"))
            {
        ...
        private void Update()
        {
            if (!this.gameObject.CompareTag("animals")) // If animal the script is attached to is not a chicken, animate 4 legs and body.
            {
